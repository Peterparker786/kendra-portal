...
const PROMPT = [
  ...
  '  "docType": "one of: Aadhaar Card, Aadhaar Correction, PAN Card, Niwas Praman (Residence), Domicile Certificate, Cast Certificate, Income Certificate, Birth Certificate, Death Certificate, Marriage Registration, Voter ID, Ration Card, Student / University Registration, Scholarship Documents, Other",',
  '  "fields": {',
  '    "customerName": "", "fatherName": "", "dob": "", "gender": "",',
  '    "aadhaarNo": "", "address": "", "phone": "", "docNo": "",',
  '    "panNo": "", "issueDate": "", "validTill": "", "issuedBy": ""',
  '  }',
  '}',
